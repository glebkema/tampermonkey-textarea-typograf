...
describe('class Typograf', function() {
	...
	context('method improveYo()', function() {
		...
		testYo('Всё верно,Всё напрасно,Всё очень просто,Всё понятно,Всё правильно,Всё просто,Всё путём,Всё равно,Всё так же,Всё то же,Всё точно,Всё ясно');  // TODO: ??? "Всё чётко" >>> "Все чётко"
